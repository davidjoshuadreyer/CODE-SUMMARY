...
let md = fs.readFileSync(BASE + '/Bromination_Lab_Report.md', 'utf8');
const svg = fs.readFileSync(BASE + '/bromination_arrhenius.svg', 'utf8');
...
// Inline the SVG chart
body = body.replace(/<img[^>]*bromination_arrhenius\.svg[^>]*>/g, svg);

// Page break before Introduction specifically
...
svg{max-width:100%;display:block;margin:16px auto;page-break-inside:avoid;break-inside:avoid}
...
<head>
<meta charset="UTF-8">
<title>Lab 8 — Bromination of Acetone</title>
<style>
${katexCSS}
${css}
</style>
...
fs.writeFileSync(BASE + '/Bromination_Lab_Report.html', html, 'utf8');
