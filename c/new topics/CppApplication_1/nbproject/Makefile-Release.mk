...
# Object Files
OBJECTFILES= \
	${OBJECTDIR}/sum\ of\ array\ columns.o
...
.NO_PARALLEL:${OBJECTDIR}/sum\ of\ array\ columns.o
${OBJECTDIR}/sum\ of\ array\ columns.o: sum\ of\ array\ columns.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sum\ of\ array\ columns.o sum\ of\ array\ columns.c
